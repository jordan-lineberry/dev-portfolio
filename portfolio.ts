...
export const openSource = {
  githubUserName: "jordan-lineberry",
};

export const contact = {};

export const socialLinks: SocialLinksType = {
  // email: "mailto:lalunah854@gmail.com",
  // github: "https://github.com/jordan-lineberry",
...
export const feedbacks: FeedbackType[] = [
  {
    name: "Curtis Blackthorne",
    role: "Engineering Manager at Bellese",
    feedback:
      "You were a wonderful addition to our team. I'm quite impressed with your abilities and professional practices. You approach problems from a unique perspective and always ask the right question. Finding a good teammate like Nirwalah is extremely difficult. He has contributed to the growth of our organization and continues to do so. May Allah bless you with everything you desire.",
  },
  {
    name: "Wajahat Malek",
    role: "CEO at Duseca Software",
    feedback:
      "Nirwalah has a deep understanding of web development technologies and is adept at using them to build scalable, robust, and secure web applications. He has worked on various projects, ranging from small-scale to large-scale, and has shown his ability to work collaboratively with others while maintaining a high level of productivity and quality. Hanzla is a pleasure to work with, and I have no doubt that he will be an asset to any team or organization. I highly recommend Hanzla for any Full Stack Django, React.js, or Blockchain development projects, and I wish him all the best in his future endeavors.",
  },
  {
    name: "Zaid Zaffar",
...
export const seoData: SEODataType = {
  title: "Nirwalah Ningsih",
  description: greetings.description,
  author: "Nirwalah Ningsih",
  keywords: [
    "Nirwalah",
    "Nirwalah Ningsih",
    "@1hanzla100",
